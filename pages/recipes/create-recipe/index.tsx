        ...
        <div>
            {/* <header>
                <div className="max-w-7xl mx-auto">
                    <h1 className="text-3xl tracking-tight font-bold leading-tight text-gray-900">Neues Rezept:</h1>
                </div>
            </header> */}
                            ...
                            <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                ...
                                <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                    ...
                                    <div className="mt-1 sm:mt-0 sm:col-span-2">
                                        ...
                                        onDrop={(e)=>{e.preventDefault(); e.stopPropagation(); setDragging(false); console.log(e.dataTransfer.files[0])}}
                                            ...
                                            <div className="space-y-1 text-center">
                                                ...
                                                <div className="flex text-sm text-gray-600">
                                                    ...
                                                    >
                                                        ...
                                                        <input id="file-upload" name="file-upload" type="file" className="sr-only" accept="image/*" onChange={(e) => console.log(e.target.files)}
                                                        />
                                                    </label>
